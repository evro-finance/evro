...
contract UniV3Exchange is LeftoversSweep, UniPriceConverter, IExchange {
    ...
    constructor(IERC20 _collToken, IEvroToken _evroToken, uint24 _fee, ISwapRouter _uniV3Router) {
    ...
    function _zeroForOne(IEvroToken _evroToken, IERC20 _collToken) internal pure returns (bool) {
        return address(_evroToken) < address(_collToken);
    }
}
