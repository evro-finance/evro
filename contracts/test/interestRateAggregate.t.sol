...
contract InterestRateAggregate is DevTestSetup {
    ...
    function testOpenTroveMintsInterestToSP() public {
        priceFeed.setPrice(2000e18);
        assertEq(evroToken.balanceOf(address(stabilityPool)), 0);
    ...
    function testCloseTroveReducesBorrowerEvroBalByEntireTroveDebtLessGasComp() public {
        ...
        assertEq(evroToken.balanceOf(B), bal_B - (entireDebt_B));
    }
    ...
    function testAdjustTroveInterestRateMintsAggInterestToSP() public {
        ...
        // Get SP balance
        uint256 spBal_1 = evroToken.balanceOf(address(stabilityPool));
    ...
    function testWithdrawEvroMintsAggInterestAndUpfrontFeeToSP() public {
        ...
        uint256 balanceBefore = evroToken.balanceOf(address(stabilityPool));
