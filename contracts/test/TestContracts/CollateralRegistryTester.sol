...
contract CollateralRegistryTester is CollateralRegistry {
    constructor(IEvroToken _evroToken, IERC20Metadata[] memory _tokens, ITroveManager[] memory _troveManagers, address _governor, address _collateralGovernor)
        CollateralRegistry(_evroToken, _tokens, _troveManagers, _governor, _collateralGovernor)
    {}
