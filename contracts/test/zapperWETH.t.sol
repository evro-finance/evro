...
contract ZapperWETHTest is DevTestSetup {
    ...
    function testCanRepayEvro() external {
        ...
        // Approve and repay
        vm.startPrank(B);
        evroToken.approve(address(wethZapper), evroAmount2);
        wethZapper.repayEvro(troveId, evroAmount2);
        vm.stopPrank();
    ...
    function testCanWithdrawEvro() external {
        ...
        // Withdraw evro
        vm.startPrank(B);
        wethZapper.withdrawEvro(troveId, evroAmount2, evroAmount2);
        vm.stopPrank();
    ...
    function testCanAdjustTroveWithdrawCollAndEvro() external {
        ...
        vm.startPrank(B);
        wethZapper.adjustTroveWithRawETH(troveId, ethAmount2, false, evroAmount2, true, evroAmount2);
        vm.stopPrank();
    ...
    function testCanAdjustTroveAddCollAndEvro() external {
        ...
        vm.startPrank(B);
        evroToken.approve(address(wethZapper), evroAmount2);
        wethZapper.adjustTroveWithRawETH{value: ethAmount2}(troveId, ethAmount2, true, evroAmount2, false, evroAmount2);
        vm.stopPrank();
    ...
    function testCanAdjustZombieTroveWithdrawCollAndEvro() external {
        ...
        // Adjust (withdraw coll and Evro)
        vm.startPrank(B);
        wethZapper.adjustZombieTroveWithRawETH(troveId, ethAmount2, false, evroAmount2, true, 0, 0, evroAmount2);
        vm.stopPrank();
    ...
    function testCanAdjustZombieTroveAddCollAndWithdrawEvro() external {
        ...
        wethZapper.adjustZombieTroveWithRawETH{value: ethAmount2}(
            troveId, ethAmount2, true, evroAmount2, true, 0, 0, evroAmount2
        );
        vm.stopPrank();
    ...
    function testExcessRepaymentByAdjustGoesBackToUser() external {
        ...
        assertEq(evroToken.balanceOf(address(wethZapper)), 0, "Zapper BOLD bal should be zero");
