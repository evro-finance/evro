...
export const EnvSchema = v.pipe(
  ...
  v.transform((data) => {
    ...
    WHITE_LABEL_CONFIG.tokens.collaterals.forEach((collateral, index) => {
      ...
      if (!deployment) {
        console.warn(
          `⚠️  No deployment for ${collateral.symbol} on chain ${env.CHAIN_ID}, skipping...`
        );
        return;
      }
      ...
      const contracts: Record<ContractEnvName, Address> = {
        ACTIVE_POOL:
          deployment.activePool || "0x0000000000000000000000000000000000000000",
        BORROWER_OPERATIONS:
          deployment.borrowerOperations ||
          "0x0000000000000000000000000000000000000000",
        COLL_SURPLUS_POOL:
          deployment.collSurplusPool ||
          "0x0000000000000000000000000000000000000000",
        COLL_TOKEN:
          deployment.collToken || "0x0000000000000000000000000000000000000000",
        DEFAULT_POOL:
          deployment.defaultPool ||
          "0x0000000000000000000000000000000000000000",
        LEVERAGE_ZAPPER:
          deployment.leverageZapper ||
          "0x0000000000000000000000000000000000000000",
        PRICE_FEED:
          deployment.priceFeed || "0x0000000000000000000000000000000000000000",
        SORTED_TROVES:
          deployment.sortedTroves ||
          "0x0000000000000000000000000000000000000000",
        STABILITY_POOL:
        ...
        TROVE_MANAGER:
          ...
          "0x0000000000000000000000000000000000000000",
        TROVE_NFT:
          deployment.troveNFT || "0x0000000000000000000000000000000000000000",
      };
